    ...
    <div className="seller-sidebar">
      <div className="review-card">
        <div className="reviewer">
          ...
          <p>
          FRESH-CART<span>Platform</span>
          </p>
        </div>
      </div>
      <div className="delivery-info">
        <h1>
          Unlock New Opportunities with FRESH-CART: The Ultimate
          Marketplace for Growing Your Business!
        </h1>
        <p>
          Join a thriving community of sellers on FRESH-CART and tap
          ...
          revenue, or connect with more customers, FRESH-CART is the
