...
export const SellerRegistrationPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    formData.append(
      "businessDescription",
      collectedData.businessDetails.businessDescription
    );
    ...
    formData.append(
      "mobilePayment",
      String(collectedData.paymentDetails.mobilePayment)
    );
    formData.append(
      "bankPayment",
      String(collectedData.paymentDetails.bankPayment)
    );
          ...
          <div>
            {step === 1 && (
              <BusinessDetails
                ...
                updateFormData={(data) =>
                  updateFormData(data, "businessDetails")
                }
              />
            )}
            {step === 2 && (
            ...
            {step === 3 && (
              <PaymentDetails
                ...
                updateFormData={(data) =>
                  updateFormData(data, "paymentDetails")
                }
